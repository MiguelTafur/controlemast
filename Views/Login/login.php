...
<html lang="es">
  ...
  <body>
    ...
    <section class="login-content">
      <div class="logo">
        <img src="<?= media();?>/images/LogotipoControle-removebg-preview-fotor-20240521143345.png" alt="CONTROLEMAST">
      </div>
      ...
      <div class="login-box">
        ...
        <form class="login-form" id="formLogin" name="formLogin" action="">
          ...
          <div class="form-group">
            <div class="form-group">
              <label class="txtRuta">EMPRESA</label>
              <input id="txtRuta" name="txtRuta" class="form-control" type="text" placeholder="Empresa" autofocus>
            </div>
            <div class="form-group">
          ...
          <div class="form-group btn-container">
            <button type="submit" class="btn btn-primary btn-block"><i class="fas fa-sign-in-alt"></i> INICIAR SESSÃO</button>
          </div>
        </form>
