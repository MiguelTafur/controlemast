...
class CoordinadoresModel extends Mysql
{
	...
	public function insertCoordinador(int $matricula, string $nombre, string $apellido, int $telefono, string $email, int $tipoid, int $ruta)
	{
	...
	public function updateCoordinador(int $idUsuario, string $matricula, string $nombre, string $apellido, int $telefono, string $email)
	{
	...
	public function selectCoordinadores()
	{
	...
	public function selectCoordinador(int $idpersona)
	{
		...
		$sql = "SELECT 
				...
				AND rolid = ".RCOORDINADOR;
		$request = $this->select($sql);
		return $request;
	}

	public function deleteCoordinador(int $idtipousuario)
	{
