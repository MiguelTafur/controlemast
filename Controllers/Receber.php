	...
	public function getRecebidos()
	{
		if($_SESSION['permisosMod']['r']){
			...
			for ($i=0; $i < count($arrData); $i++) {
				...
				$arrData[$i]['equipamento'] = '<h5>'.$tipo.' <span style="cursor: pointer;" class="badge badge-secondary" onClick="fntViewFone('.$arrData[$i]['equipamentoid'].')">#'.$arrData[$i]['lacre'].'</span></h5>';
